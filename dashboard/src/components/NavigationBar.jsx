...
const NavigationBar = () => {
	...
	return (
		<motion.div
			...
			<motion.div className={isExpanded ? "block" : "hidden"}>
						...
						<div>
							<div className="flex flex-col items-center ">
								<div className="flex my-2 w-full justify-between">
									...
									<p className="text-sm text-right">23.5GB/1TB</p>
								</div>
							...
							<div className="flex flex-col items-center">
								<div className="flex my-2 w-full justify-between">
									<span className="">Banda Mensual</span>
									<p className="text-sm text-right">3.4GB/5TB</p>
								</div>
								<div className="w-full h-2 bg-blue-200 rounded-full">
